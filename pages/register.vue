  ...
  <div class="container l--table">
    ...
    <div class="box box--m">
      ...
      <fieldset class="input--wrap">
        ...
        <input id="name" type="text" placeholder="30자 이하로 입력해 주세요" class="input--text input--text--white">
      </fieldset>
      <fieldset class="input--wrap">
      ...
      <fieldset class="input--wrap">
        ...
        <input id="member" type="text" placeholder="아이디로 입력해 주세요" class="input--text input--text--white">
        <button @click.prevent="addParticipants" class="btn--submit btn--submit--s">
            추가
          </button>
        </div>
      </fieldset>
      ...
      <fieldset class="input--wrap">
        ...
        <div class="inline__wrap">
          <span class="inline detail">오늘로부터</span><input id="period" type="number" class="input--text input--text--white w--small inline" readonly="readonly"><span class="inline detail">일 동안</span>
        </div>
      </fieldset>
      <button
          @click="regSchedule"
         class="btn--submit mg--m"
        >
          약속 만들기
        </button>
      </div>
